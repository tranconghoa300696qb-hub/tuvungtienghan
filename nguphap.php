...
<head>
    ...
    <style>
        ...
        .korean-text {
            ...
            /* Để hiển thị xuống dòng từ mảng dữ liệu */
            line-height: 1.4;
        }
...
<body>
    ...
    <script>
        const data = [
            ...
            {
                title: "patchim ㄹ + ㅅ , ㅂ, ㄴ, ㅁ, ㄹ (Sườn,bò,nướng,mì lạnh)",
                grammar: "các từ có patchim là ㄹ khi kết hợp với các từ có phụ âm đầu là ㅅ, ㅂ, ㄴ, ㅁ, ㄹ-> patchim ㄹ biến mất",
                detail: "",
            kr: [
                "만들다 + 네요 =   만드 + 네요 = 만드네요",
                "알다 +  세요=  아세요",
            ...
            },
            {
                ...
                {
                title: "BQT patchim ㅅ + Nguyên âm -> Mất ㅅ",
                grammar: "",
                detail: "",
                kr: [
                    "짓다 + 어요 -> 지어요",
                ...
                vi: "Lưu ý s bị mất nhưng vẫn coi là có patchim 짓다 + 을게요 -> 지을게요"
            },
        ];
